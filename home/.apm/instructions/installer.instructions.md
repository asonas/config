...
- Apply the global APM configuration and regenerate generated agent instructions with `mise run apm:apply`; do not use `install.sh` as a compilation or documentation-generation step.
