...
#
# 環境変数:
#   OBSIDIAN_VAULT: 指定する場合もObsidianの登録先との一致を検証する

set -u

VAULT_DIR=$(mise exec -- ruby -I "$HOME/.agents/skills/obsidian-vault/scripts" -r resolve-vault -e 'puts ObsidianVault.resolve') || exit 2
